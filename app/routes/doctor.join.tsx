        ...
        <ol className="space-y-4">
          <li className="flex items-start">
            ...
            <span>
              ...
              professional profile with your specialties, qualifications, and a
              brief bio.
            </span>
          </li>
          <li className="flex items-start">
          ...
          <li className="flex items-start">
            <CheckCircle className="mr-2 h-6 w-6 flex-shrink-0 text-primary" />
            <span>
              <strong>Provide Care:</strong> Use the platform to access patient
              information, update records, and ensure continuity of care across
              all your practice locations.
            </span>
          </li>
        </ol>
      </div>
